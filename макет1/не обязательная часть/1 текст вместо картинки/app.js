...
function showMoreText(card) {
    ...
    let txt = 'Lorem ipsum  quod quos tempore? Porro quaerat rerum tenetur voluptatum.';
    card.productName.insertAdjacentHTML(`afterend`, `<div class = 'desc'>${txt}</div>`);
