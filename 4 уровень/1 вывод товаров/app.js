...
function showCategory(category) {
    if (category === 'phones') {
        products.phones.forEach(function (i) {
            getProductMarkup(i);
        });
    } else if (category === 'tablets') {
        products.tablets.forEach(function (i) {
            getProductMarkup(i);
        });
    } else if (category === 'tv') {
        products.tv.forEach(function (i) {
            getProductMarkup(i);
        });
    }
}
...
<div>${product.name}</div>
    ...
    <a href="https://example.com/producs/${product.id}">Подробнее</a><hr>`);
}
